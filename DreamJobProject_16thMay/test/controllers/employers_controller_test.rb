...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { company_name: @employer.company_name, company_phone: @employer.company_phone, contact_person_name: @employer.contact_person_name, ein: @employer.ein }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { company_name: @employer.company_name, company_phone: @employer.company_phone, contact_person_name: @employer.contact_person_name, ein: @employer.ein }
    assert_redirected_to employer_path(assigns(:employer))
  end
